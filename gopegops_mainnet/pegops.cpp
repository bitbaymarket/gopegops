        ...
        std::string &   out_err)
{
    ...
    out_positive    = pd.fractions.IsPositive();
    return true;
}
        ...
        std::string &   out_err)
{
    ...
    out_empty    = pd.fractions.IsEmpty();
    return true;
}
        ...
        std::string &   out_err)
{
    ...
    int nSupplyEffective = pdFrom.peglevel.nSupply+pdFrom.peglevel.nShift;
    pdFrom.nLiquid = pdFrom.fractions.High(nSupplyEffective);
    pdFrom.nReserve = pdFrom.fractions.Low(nSupplyEffective);
        ...
        std::string &   out_err)
{
    ...
    int pegn_liquid = peglevel.nSupplyNext - peglevel.nBuffer;
    int pegn_reserve = peglevel.nSupplyNext;
