...
#ifndef BITBAY_PRIMITIVES_TRANSACTION_H
#define BITBAY_PRIMITIVES_TRANSACTION_H
...
public:
    ...
    std::string ToString() const
    {
        ...
        return strprintf("CTxOut(nValue=%d, scriptPubKey=%s)", nValue, scriptPubKey.ToString());
    }
};
...
#endif // BITBAY_PRIMITIVES_TRANSACTION_H
