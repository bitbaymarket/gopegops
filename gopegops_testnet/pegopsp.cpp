...
//                          peglevel_exchange);
    ...
    pdPegShift.peglevel = peglevel_exchange;
    pdPegShift.nLiquid = pdPegShift.fractions.High(peglevel_exchange);
    pdPegShift.nReserve = pdPegShift.fractions.Low(peglevel_exchange);
